import type { variant, size, color, label, error, success, arrow, value, onChange, selected, offset, dismiss, animate, autoHeight, lockScroll, labelProps, menuProps, className, disabled } from "../../../types/components/select";
