...
const NavbarComponent = ({ children, menuOpen, fluid = false, rounded, border, ...props }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(NavbarContext_1.NavbarContext.Provider, { value: { isOpen, setIsOpen }, children: (0, jsx_runtime_1.jsx)("nav", { className: (0, classnames_1.default)(theme.base, theme.bordered[border ? 'on' : 'off'], theme.rounded[rounded ? 'on' : 'off']), ...theirProps, children: (0, jsx_runtime_1.jsx)("div", { className: (0, classnames_1.default)(theme.inner.base, theme.inner.fluid[fluid ? 'on' : 'off']), children: children }) }) }));
};
